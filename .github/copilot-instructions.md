...
- This repository contains personal utilities and configuration, including a repo-driven shell configuration setup.
...
- For shell-config changes, favor clear startup-file responsibilities, direct sourcing or symlinks over copy-based refresh flows, and validation in fresh shell sessions.
